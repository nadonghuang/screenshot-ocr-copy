...
- **实时预览** — 拖动选区时即可看到识别结果
- **自动复制** — 识别完成自动写入剪贴板，配 Glass 音效与系统通知
- **历史记录** — 菜单栏查看最近 20 条识别结果，一键复用
- **开机自启** — 可选开机自动后台运行
- **可自定义** — 快捷键实时录制、音效/通知开关、选框线宽
...
同时通过 Unicode 白名单过滤 Vision 对 emoji/图标的误识别。
